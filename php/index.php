...
{
    $data = getCookies();
    $random = random_int(0, 430);
    $cookie = $data[$random];

    // put query params into $query
    parse_str($params['__ow_query'], $query);
    ...
    // useful as status will be visible in the event of an error
