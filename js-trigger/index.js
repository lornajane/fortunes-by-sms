...
// send number and secret
exports.main = function (params) {
    // check the secret first
    if(params.secret != "" && params.secret == params.sharedsecret) {
        ...
        console.log("Mismatched or missing secrets");
        return {"statusCode": 401, "body": "Secret did not match"};
    }
}
